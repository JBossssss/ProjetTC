...
def Param(TAB,maxq,maxk=None):
    ...
    expander = st.expander("Entrée des paramètres du filtre")
...
def Result(NAME,DATA,N,D,n=None,d=None):
    ...
    with open(data, 'w') as file:
        ...
        with expander:  
            chx=st.radio('Choisir de voir la fonction de transfert :', ['Théorique', 'Réelle, avec les composants calculés/choisies'])
            if chx=='Théorique':
                NUM=N
                DEN=D
            else:
